                                        ...
                                        <div class="col-sm-12">
                                            <div class="statistics-details d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="d-none d-md-block">
                                                    ...
                                                    <h3 class="rate-percentage"><span style="font-size: 10px;">あと</span> 3 <span style="font-size: 10px;">日</span></h3>
                                                    <p class="text-success d-flex"><i class="mdi mdi-menu-down"></i><span>+0.8%</span></p>
                                                </div>
                                            </div>
                                        </div>
                                                                ...
                                                                <td>
                                                                    <div>
                                                                        <div class="d-flex justify-content-between align-items-center mb-1 max-width-progress-wrap">
                                                                            <p class="text-success">{{round($total_progress, 1)}} %</p>
                                                                            <p>{{$OK_count}} / {{$BSS_count}}</p>
                                                                        </div>
                                                                        <div class="progress progress-md">
                                                                            <div class="progress-bar bg-success" role="progressbar" style="width: {{round($total_progress, 1)}}%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                                                        </div>
                                                                    </div>
                                                                </td>
